...
export type ColorId = "berry_red" | "red" | "orange" | "yellow" | "olive_green" | "lime_green" | "green" | "mint_green" | "teal" | "sky_blue" | "light_blue" | "blue" | "grape" | "violet" | "lavender" | "magenta" | "salmon" | "charcoal" | "grey" | "taupe"
...
export interface Project extends NodeType {
  ...
  team_inbox?: true
  /** Type of display a client should use for this project */
  view_style?: string
}
...
export interface User extends NodeType {
  ...
  full_name: string
  /** This will be false if user is using SSO or 3rd party auth provider */
  ...
  weekly_goal: number
  /** What day is used when a task is scheduled for Weekend */
...
export interface UserUpdate {
  ...
  /** The user’s real name formatted as Firstname Lastname. */
  full_name?: string
  /** The current password -- used when changing password and has_password is true */
